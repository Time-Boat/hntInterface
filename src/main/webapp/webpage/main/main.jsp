...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	<!-- 顶部-->
	<div region="north" border="false" title=" 欢迎使用" style="background: url(plug-in/login/images/mxbg.jpg) ;height: 110px; padding: 1px; overflow: hidden;">
		<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#01489A;">
			<tr>
				<td align="left" style="vertical-align:text-bottom;background-color:#01489A;"><img src="plug-in/login/images/zgjj/top.png" ></td>
				<td align="right">
					<table>
						<tr>
							<td valign="top" height="50"><span style="color:#FFFFFF">当前用户:</span><span style="color:#FFFFFF">${userName }</td>
						</tr>
						<tr>
						<td>
	...
	<!-- 左侧-->
	<div region="west" split="true" href="loginController.do?left" title="导航菜单" style="width: 200px; padding: 1px;overflow:scroll;"></div>
	<!-- 中间-->
	...
	<div region="south" border="false" style="height: 25px; overflow: hidden;">
		<div align="center" style="color: #CC99FF; padding-top: 2px">
			 版权所有 &copy;<span class="tip"><a target="_blank" href=""  title=" ">上海同望信息技术有限公司</a></span>
		</div>
	</div>
