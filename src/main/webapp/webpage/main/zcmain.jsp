...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	<!-- 顶部-->
	<div region="north" border="false" title=" 欢迎使用" style="background: url(plug-in/login/images/zcbg.jpg) ;height: 80px; padding: 1px; overflow: hidden;">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="left" style="vertical-align:text-bottom;"><img src="plug-in/login/images/zchead.jpg" >
      			</td>
	...
	<div region="south" border="false" style="height: 25px; overflow: hidden;">
		<div align="center" style="color: #CC99FF; padding-top: 2px">
			&copy; 版权所有 <span class="tip"><a target="_blank" href="http://www.shtoone.cn"  title=" 上海同望">上海同望软件有限公司</a> &nbsp;&nbsp; 技术支持:<a target="_blank" href="http://www.shtoone.cn" title=" 上海同望">021-61538292</a>
			</span>
		</div>
	</div>
