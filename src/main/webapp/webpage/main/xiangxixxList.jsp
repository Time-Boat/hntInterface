...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="xiangxixxList" title="xx" actionUrl="xiangxixxController.do?datagrid" idField="id"  pageSize="15" >  
   ...
   <t:dgDelOpt title="删除" url="xiangxixxController.do?del&id={id}" />
   <t:dgToolBar title="录入" icon="icon-add" url="xiangxixxController.do?addorupdate" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="xiangxixxController.do?addorupdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="xiangxixxController.do?addorupdate" funname="detail"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>