...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="v_YalijiNList" title="压力试验子表" actionUrl="v_YalijiNController.do?datagrid" idField="id" fit="true">
   ...
   <t:dgCol title="fGuid" field="fGuid" ></t:dgCol>
   <t:dgCol title="sjxh" field="sjxh" ></t:dgCol>
   <t:dgCol title="zzjj" field="zzjj" ></t:dgCol>
   <t:dgCol title="kylz" field="kylz" ></t:dgCol>
   <t:dgCol title="kyqd" field="kyqd" ></t:dgCol>
   <t:dgCol title="sysj" field="sysj" ></t:dgCol>
   <t:dgCol title="wcsj" field="wcsj" ></t:dgCol>
   <t:dgCol title="yskylz" field="yskylz" ></t:dgCol>
   <t:dgCol title="sjgc" field="sjgc" ></t:dgCol>
   <t:dgCol title="ystatus" field="ystatus" ></t:dgCol>
   <t:dgCol title="recGuid" field="recGuid" ></t:dgCol>
   <t:dgCol title="testname" field="testname" ></t:dgCol>
   <t:dgCol title="shebeiname" field="shebeiname" ></t:dgCol>
   <t:dgCol title="shebeijiancheng" field="shebeijiancheng" ></t:dgCol>
   <t:dgCol title="fTrname" field="fTrname" ></t:dgCol>
   <t:dgCol title="lft" field="lft" ></t:dgCol>
   <t:dgCol title="rgt" field="rgt" ></t:dgCol>
   <t:dgCol title="操作" field="opt" width="100"></t:dgCol>
   <t:dgDelOpt title="删除" url="v_YalijiNController.do?del&id={id}" />
   <t:dgToolBar title="录入" icon="icon-add" url="v_YalijiNController.do?addorupdate" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="v_YalijiNController.do?addorupdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="v_YalijiNController.do?addorupdate" funname="detail"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>