...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="v_SYJZBNController.do?save">
			<input id="id" name="id" type="hidden" value="${v_SYJZBNPage.id }">
