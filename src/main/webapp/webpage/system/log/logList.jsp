...
<t:datagrid title="日志管理" name="logList" actionUrl="logController.do?datagrid" idField="id" sortName="operatetime" sortOrder="desc" pageSize="15" extendParams="view:scrollview,">
