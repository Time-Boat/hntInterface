...
<t:datagrid name="userList" title="用户管理" actionUrl="userController.do?datagrid" fit="true" fitColumns="true" idField="id" queryMode="group">
	...
	<t:dgCol title="职务" field="userKey" query="true"></t:dgCol>
	<t:dgCol title="状态" sortable="true" field="status" replace="正常_1,禁用_0,超级管理员_-1"></t:dgCol>
	<t:dgCol title="操作" field="opt"></t:dgCol>
	<t:dgDelOpt title="删除" url="userController.do?del&id={id}&userName={userName}"  operationCode="del"/>
	...
	<t:dgToolBar title="重置密码" icon="icon-edit" url="userController.do?changepasswordforuser" funname="update" operationCode="resetpwd"></t:dgToolBar>
