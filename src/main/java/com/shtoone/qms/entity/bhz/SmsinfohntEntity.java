 ...
 */
@Entity
@Table(name = "Smsinfohnt", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class SmsinfohntEntity implements java.io.Serializable {
	/**id*/
	...
	/**yonghumingchen*/
	private java.lang.String yonghumingchen;
	/**chuliaoshijian*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  yonghumingchen
	 */
	@Column(name ="YONGHUMINGCHEN",nullable=true,precision=100,length=100)
	public java.lang.String getYonghumingchen(){
		return this.yonghumingchen;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  yonghumingchen
	 */
	public void setYonghumingchen(java.lang.String yonghumingchen){
