...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	<!-- 顶部-->
	<div region="north" border="false" title=" 欢迎使用" style="background: url(plug-in/login/images/hwbg.jpg);height: 85px; padding: 1px; overflow: hidden;">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="left" style="vertical-align:text-bottom;"><img src="plug-in/login/images/hwhead.jpg;" >
      			</td>
				<td align="right" nowrap>
					<table>
						<tr>
							...
							String pwd = com.shtoone.qms.util.StringUtil.getMD5(username+"_"+ts+"_hwdq");
							String url="http://112.124.118.94:8081/hwdqmss/main/comelogin?userid="+java.net.URLEncoder.encode(username,"UTF-8")+"&timestamp="+ts+"&pwd="+pwd;
							%>
							<a  target="_blank"  href="<%=url%>">进入拌和站物联网集成信息管理系统</a>
	...
	<div region="south" border="false" style="height: 25px; overflow: hidden;">
		<div align="center" style="color: #CC99FF; padding-top: 2px">
			&copy; 版权所有 <span class="tip"><a target="_blank" href="http://www.shtoone.cn"  title=" 上海同望">上海同望信息技术有限公司</a> &nbsp;&nbsp; 技术支持:<a target="_blank" href="http://www.shtoone.cn" title=" 上海同望">021-61538292</a>
			</span>
		</div>
	</div>
