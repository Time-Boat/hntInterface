...
<t:formvalid formid="formobj" layout="div" dialog="true" action="demoController.do?saveDemo">
	...
	<fieldset class="step">
	<div class="form"><label class="Validform_label"> DEMO名称1： </label> <input name="demotitle" class="inputxt" value="${demo.demotitle}" datatype="s2-50"> <span class="Validform_checktip"></span></div>
