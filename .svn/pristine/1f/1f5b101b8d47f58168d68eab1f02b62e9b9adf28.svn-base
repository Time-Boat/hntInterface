...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="topRealMaxhunnintuViewList" title="水泥混凝土刷新最新数据" actionUrl="topRealMaxhunnintuViewController.do?datagrid" idField="id" fit="true">
   ...
   <t:dgDelOpt title="删除" url="topRealMaxhunnintuViewController.do?del&id={id}" />
