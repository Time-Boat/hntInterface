...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hntxiangxixxmaxList" title="最大一笔详细信息" actionUrl="hntxiangxixxmaxController.do?datagrid" idField="id" fit="true">
   ...
   <t:dgCol title="kehuduanbianhao" field="kehuduanbianhao" ></t:dgCol>
   ...
   <t:dgCol title="caijiyanshi" field="caijiyanshi" ></t:dgCol>
   <t:dgCol title="shangchuanyanshi" field="shangchuanyanshi" ></t:dgCol>
   ...
   <t:dgCol title="smstype" field="smstype" ></t:dgCol>
   <t:dgCol title="sendtype" field="sendtype" ></t:dgCol>
   <t:dgCol title="panshu" field="panshu" ></t:dgCol>
   <t:dgCol title="ambegin" field="ambegin" ></t:dgCol>
   <t:dgCol title="amend" field="amend" ></t:dgCol>
   <t:dgCol title="pmbegin" field="pmbegin" ></t:dgCol>
   <t:dgCol title="pmend" field="pmend" ></t:dgCol>
   <t:dgCol title="smssettype" field="smssettype" ></t:dgCol>
   <t:dgCol title="操作" field="opt" width="100"></t:dgCol>
   <t:dgDelOpt title="删除" url="hntxiangxixxmaxController.do?del&id={id}" />
   <t:dgToolBar title="录入" icon="icon-add" url="hntxiangxixxmaxController.do?addorupdate" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="hntxiangxixxmaxController.do?addorupdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="hntxiangxixxmaxController.do?addorupdate" funname="detail"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>