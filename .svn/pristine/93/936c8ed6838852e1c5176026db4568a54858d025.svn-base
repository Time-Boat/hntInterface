		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr style="height: 25px;" align="right">
				...
				<div id="layout_north_kzmbMenu" style="width: 100px; display: none;">
					...
					<div class="menu-sep"></div>	
					<div onclick="add('修改首页风格','userController.do?changestyle')">页面风格</div>
				</div>
...
<div align="center" style="color: #1fa3e5; padding-top: 2px">&copy; 版权所有 <span class="tip"><a target="_blank" href="http://www.shtoone.cn" title="上海同望">上海同望软件有限公司</a>&nbsp;&nbsp;技术支持:<a target="_blank"  href="http://www.shtoone.cn" title="上海同望">021-61538292</a> </span></div>
</div>
