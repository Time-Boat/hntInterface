...
<div class="container-fluid"><a class="brand" href="http://www.jeecg.org" target="_blank">试验室管理平台 &nbsp;&nbsp;<span class="slogan"></span></a>
...
<ul class="nav pull-right usernav">
	...
	<ul class="dropdown-menu">
		...
		<li onclick="add('修改首页风格','userController.do?changestyle')"><a href="javascript:;"><i class="icon-retweet"></i> 页面风格</a></li>
	</ul>
	</li>
...
<ul class="footer-links">
	<li style="display: inline;">&copy; 版权所有<a target="_blank" href="http://www.shtoone.cn" title="上海同望">上海同望软件有限公司</a></li>
	<li style="display: inline;">&nbsp;&nbsp;技术支持:<a target="_blank"  title="上海同望" href="http://www.shtoone.cn">021-61538292</a></li>
</ul>
</div>
</footer>
