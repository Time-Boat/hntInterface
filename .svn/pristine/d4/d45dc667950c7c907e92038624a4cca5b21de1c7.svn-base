...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="ingroundManagerController.do?copyandsave" beforeSubmit="formValid()">
